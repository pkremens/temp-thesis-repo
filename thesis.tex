...
Aplikační servery jsou páteřní komponentou pro chod mnoha společností. Umožnují rychlé a spolehlivé sdílení dat, centralizovanou distribuci software, jednoduchou modernizaci, vysokou míru zabezpečení a zvyšují efektivitu všech firemních procesů. K tomu, aby aplikační servery sprvávě plnily svou funkci, je zapotřebí, aby i ony byly podrobovány testům.
...
\subsection{JBoss AS a glass fish}

\section{Testování}
\subsection{Baseline}
nejaky minutovy chod
\subsection{JVM}
1.6 / 1.7
...
\subsection{Rozdil bez s logem na info na konzoli a logem na fine na konzoli}
...
ruzne chovani, eclips linkem me to nejelo.
